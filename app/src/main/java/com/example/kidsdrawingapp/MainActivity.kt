...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val linearLayoutPaintColors = findViewById<LinearLayout>(R.id.linearLayout_paint_colors)
        ...
        imageButtonSave.setOnClickListener {
            if (isReadStorageAllowed()){
                ...
                lifecycleScope.launch {
                    val flDrawingView: FrameLayout = findViewById(R.id.frameLayout_drawing_view_container)
    ...
    private fun showBrushSizeChooserDialog(){
        ...
        val verysmallButton: ImageButton = brushDialog.findViewById(R.id.imageButton_verysmall_brush)
